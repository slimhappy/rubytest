...
begin
  ...
  for j in 0..(topanimation_title.size()-1)
  	puts topanimation_title[j].text.to_s+" www.bilibili.com"+topanimation_link[j].to_s
    aa[i]=Bilibili_Ranklist_Tag.new(topanimation_title[j].text.to_s+" www.bilibili.com"+topanimation_link[j].to_s)
    i = i+1
  end
